...
public class World_Trade_Login {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='reg-no']")).sendKeys("1234567890");
		driver.findElement(By.xpath("//input[@id='email-id']")).sendKeys("abc@123gmail.com");
